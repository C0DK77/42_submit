...
/*   Updated: 2025/05/07 16:39:34 by codk             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	UTILS 2
void				ft_build_patience(int *tab, int len, int *tail, int *pos,
						int *prev, int *out_lis_len);
int					*ft_tab_add_patience(int *tab, int len, int *out_lis_len);
void				ft_push_b(int lis_len, t_ps **p1, t_ps **p2, t_action **l);
void				reinsert_b_greedy(t_ps **p1, t_ps **p2, t_action **l);
int					ft_cost(int sz_a, int sz_b, int pos_a, int pos_b);
//	UTILS 3
